...
/**
 * Collection as a native tab. The PDP prefetch-and-push wiring is copied
 * verbatim from `(tabs)/index.tsx` on purpose: if this screen behaves
 * differently from the live one, the difference has to be the navigation shell
 * and nothing else, or the comparison proves nothing.
 */
