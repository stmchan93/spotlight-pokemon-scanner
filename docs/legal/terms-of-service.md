...
> codebase and every value below is filled in. It has **not** been reviewed by a qualified
> lawyer. Before or shortly after publication, counsel should confirm: (1) the sole-proprietor
> entity framing and postal-address handling; (2) the choice of California governing law and
> the decision **not** to include an arbitration clause; (3) the CSAM/NCMEC reporting process
> in Section 8; (4) DMCA designated-agent registration for Section 12; and (5) that the card
> data-provider licences (Scrydex, PokemonPriceTracker, PriceCharting, eBay) permit the use
...
These Terms of Service ("**Terms**") are a binding agreement between you and Stephen Chan, an
individual sole proprietor doing business as **Ekalight** ("**Ekalight**", "**we**", "**us**",
"**our**"), governing your use of the Ekalight mobile application (bundle identifier
`com.ekalight.app`), our backend services and APIs, and any related websites (together, the
"**Service**").
...
to our Privacy Policy at <https://stmchan93.github.io/ekalight-legal/>. If you do not agree,
do not use the Service.

## 2. Who may use the Service

You must be at least **13 years old** to use the Service. The Service is **not directed to
children**, and we do not knowingly permit users under 13 to create an account or post
content.
...
Access to the Service is currently **invite-gated**: some features require an access grant,
an invite code, or participation in an event where access is opened. We may grant, refuse, or
...
2. **Automated AI review.** Posts, comments, and images attached to posts are additionally
   ...
   This automated review runs continuously — new content is typically classified **within
   minutes of submission**. **Images you attach to a post are hidden from other users until
   this review approves them.** Direct messages are not sent to the AI reviewer; they are
   covered by step 1, blocking, and reporting.
...
4. **Human review.** Our moderators review reported and flagged content and take action.
   **We act on reports of objectionable content within 24 hours**, including removing the
   content and, where warranted, ejecting the user who provided it.
...
We aim to act proportionately. We commit to acting on reports of objectionable content within
24 hours (Section 7), but we are not obliged to remove content that does not violate these
Terms.
...
**team@ekalight.com** with the details. We will review the decision and respond within
**7 days**.
...
material will be terminated immediately and permanently, and we will report the material and
the account to the National Center for Missing & Exploited Children (NCMEC) and/or law
enforcement as required by applicable law, including 18 U.S.C. § 2258A.
...
publisher or grading company.** Card images and catalogue data are licensed from third-party
data providers and are used to identify and describe collectible cards.
...
that the notice is accurate, and your signature. We will remove or disable access to material
that a valid notice identifies as infringing, and may terminate the accounts of repeat
infringers.

## 13. Purchases

The Service is currently **free of charge** and contains **no in-app purchases and no
subscriptions**. If we introduce paid features in the future, we will update these Terms with
the applicable pricing, billing, renewal, and refund terms before charging anyone.
...
account, your private data (collection, scan records, transactions), and your stored images
(scan photographs, post images, avatar and cover) are deleted; but for safety, legal, and
integrity reasons **some material is retained**, including moderation records, records of
reports made about you, and content archives required to keep other users' conversations
intelligible. Deletion of your account does not automatically withdraw the licence in
Section 4 with respect to content that is lawfully retained.
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, NEITHER EKALIGHT NOR ANYONE WORKING ON ITS BEHALF WILL
BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE
DAMAGES, OR FOR ANY LOSS OF PROFITS, REVENUE, DATA, GOODWILL, **OR ANY LOSS ARISING FROM A
BUYING, SELLING, TRADING, OR VALUATION DECISION**, ARISING OUT OF OR RELATING TO THE SERVICE,
WHETHER IN CONTRACT, TORT, OR OTHERWISE, EVEN IF ADVISED OF THE POSSIBILITY.
...
You agree to indemnify and hold harmless Ekalight and anyone working on its behalf from any
claim, demand, loss, or expense (including reasonable legal fees) arising out of your User
...
regard to conflict-of-laws rules. You and we agree to the exclusive jurisdiction of the state
and federal courts located in **California**.

These Terms do not include an arbitration clause or a class-action waiver. If you are a
consumer in a jurisdiction whose law gives you mandatory rights or a mandatory forum, nothing
in this section takes those away.
