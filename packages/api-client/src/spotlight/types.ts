...
// Meta feed blocks — contract in docs/meta-feed-api-contracts-2026-09-23.md.
...
// Repository query shapes for the meta feed reads. Omitted fields fall back to
// the server defaults in the contract doc.
export type MetaPulseQuery = {
  game?: CardGame;
  windowDays?: number;
  lane?: MetaLaneFilter;
};

export type HotCardsQuery = {
  /** Omitted = all games. */
  game?: CardGame | null;
};

export type SetSpotlightQuery = {
